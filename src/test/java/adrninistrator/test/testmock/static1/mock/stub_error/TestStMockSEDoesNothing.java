...
public class TestStMockSEDoesNothing extends TestMockNoSpBase {

    /*
        使用PowerMockito.mockStatic方法对类进行Mock，且指定默认Answer为什么也不做
    */
    @Before
    public void init() {
    ...
    @Test
    public void test1() {
        // 当执行PowerMockito.mockStatic指定默认Answer为什么也不做时，进行Stub时使用Mockito.when()方法不会执行真实方法
    ...
    public void test2() {
        /*
            ...
            当执行PowerMockito.mockStatic方法指定默认Answer为什么也不做时，以上执行真实方法的步骤不会执行真实方法
        */
    ...
    public void test3() throws Exception {
        // 当执行PowerMockito.mockStatic指定默认Answer为什么也不做时，进行Stub时使用PowerMockito.doxxx().when()方法不会执行真实方法
