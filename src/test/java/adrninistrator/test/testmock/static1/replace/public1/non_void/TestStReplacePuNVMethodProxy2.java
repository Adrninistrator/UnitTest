...
public class TestStReplacePuNVMethodProxy2 extends TestMockNoSpBase {

    @Test
    public void test() {
        MethodProxy.proxy(TestStaticPublicNonVoid1.class, TestStaticPublicNonVoid1.NAME_TEST1, new
                TestInvocationHandler1());
        ...
        // MethodProxy.proxy也支持Replace，传入参数为Class与方法名
