...
public class TestSpMockSECallsRealMethods extends TestMockBase {
    ...
    public void init() {
        /*
            ...
            未Stub的方法不会执行真实方法
        */
        testPublicNonVoidService1Mock = Mockito.mock(TestPublicNonVoidService1.class, new CallsRealMethods());
    ...
    public void test2() {
        ...
        // 对于实现类的Mock对象，Mockito.when().thenReturn()执行1次真实方法
