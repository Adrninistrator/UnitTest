...
public class TestSpMockSEDoesNothing extends TestMockBase {
    ...
    public void init() {
        /*
            ...
            未Stub的方法不会执行真实方法
        */
        testPublicNonVoidService1Mock = Mockito.mock(TestPublicNonVoidService1.class, DoesNothing.doesNothing());
        ...
        /*
            ...
            未Stub的方法会执行真实方法
        */
        testPublicNonVoidService1ImplMock = Mockito.mock(TestPublicNonVoidService1Impl.class, DoesNothing.doesNothing());
