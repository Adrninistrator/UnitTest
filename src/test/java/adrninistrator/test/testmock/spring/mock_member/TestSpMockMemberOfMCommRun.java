...
public class TestSpMockMemberOfMCommRun extends TestMockBase {
    ...
    @Test
    public void test() {
        TestSpMockMemberOfMCommMock.mock1(testServiceB1);

        String str = testServiceB1.test1("");
        assertEquals(TestConstants.MOCKED, str);

        TestSpMockMemberOfMCommMock.mock2(testServiceB1);
