...
// Mockito.when()的Stub参数条件为：为String类型，且以指定字符串开头
public class TestStPuNVArgsStrStartsWith extends TestStaticPublicNonVoidBase {

    private static final Logger logger = LoggerFactory.getLogger(TestStPuNVArgsStrStartsWith.class);
