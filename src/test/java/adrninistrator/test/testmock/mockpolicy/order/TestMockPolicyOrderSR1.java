 ...
 */
@MockPolicy({TestPolicyOrderReplaceA.class, TestPolicyOrderStubB.class, TestPolicyOrderReplaceA.class})
public class TestMockPolicyOrderSR1 extends TestMockNoSpBase {
