...
import adrninistrator.test.testmock.mockpolicy.policy.suppress.TestPolicySuppress2;
...
/*
    在PowerMockPolicy实现类TestPolicySuppress2中
    分别禁止了TestStaticPublicNonVoid1类的flag变量，TestServiceB1Impl类的testServiceA1变量
    使用settings.addFieldToSuppress方法，参数为Field数组
 */
