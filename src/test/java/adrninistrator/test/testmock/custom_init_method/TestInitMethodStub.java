...
import adrninistrator.test.testmock.custom_init_method.init_method.TestInitStub1;
import adrninistrator.test.testmock.custom_init_method.init_method.TestInitStub2;
...
/*
    使用自定义注解@TestInitAnnotation执行指定的初始化操作，Stub
 */
@TestInitAnnotation({TestInitStub1.class, TestInitStub2.class})
@PrepareForTest({TestStaticPublicNonVoid1.class, TestPublicNonVoidService1Impl.class})
public class TestInitMethodStub extends TestMockBase {
