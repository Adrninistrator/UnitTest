...
// 修改TestServiceEG1Impl.checkA()方法通过检查
public class TestInitEGANotPass implements TestInitInterface {

    @Override
    public void init() {
        PowerMockito.stub(PowerMockito.method(TestServiceEG1Impl.class, TestEGCommon.NAME_CHECKA)).toReturn(false);
    }
}