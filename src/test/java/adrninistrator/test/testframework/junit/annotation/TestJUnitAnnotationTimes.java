...
public class TestJUnitAnnotationTimes {
    ...
    public static void afterClass() {
        ...
        assertEquals(1, TestCallTimesUtil.getCallTimes(TestJUnitAnnotationTimes.class, NAME_BEFORECLASS));
        assertEquals(2, TestCallTimesUtil.getCallTimes(TestJUnitAnnotationTimes.class, NAME_BEFORE));
        assertEquals(1, TestCallTimesUtil.getCallTimes(TestJUnitAnnotationTimes.class, NAME_TEST1));
        assertEquals(1, TestCallTimesUtil.getCallTimes(TestJUnitAnnotationTimes.class, NAME_TEST2));
        assertEquals(2, TestCallTimesUtil.getCallTimes(TestJUnitAnnotationTimes.class, NAME_AFTER));
        assertEquals(1, TestCallTimesUtil.getCallTimes(TestJUnitAnnotationTimes.class, NAME_AFTERCLASS));
    }
}
