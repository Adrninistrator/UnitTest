...
//Mockito.when()的Stub参数条件为非空
public class TestStPuNVArgsIsNotNull extends TestStaticPublicNonVoidBase {

    private static final Logger logger = LoggerFactory.getLogger(TestStPuNVArgsIsNotNull.class);
    ...
    public void test() {
        ...
        str = TestStaticPublicNonVoid1.test1(null, null);
