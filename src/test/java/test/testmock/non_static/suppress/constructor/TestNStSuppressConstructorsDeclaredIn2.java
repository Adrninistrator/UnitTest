...
//SuppressCode.suppressConstructor(PowerMockito.constructorsDeclaredIn())支持禁止类的全部构造函数
public class TestNStSuppressConstructorsDeclaredIn2 extends TestNStSuppressConstructorBase {

    @Test
    public void test1() {

        SuppressCode.suppressConstructor(PowerMockito.constructorsDeclaredIn(TestNonStatic3.class));
    ...
    public void test2() {
        ...
        SuppressCode.suppressConstructor(PowerMockito.constructorsDeclaredIn(TestNonStatic4.class));
