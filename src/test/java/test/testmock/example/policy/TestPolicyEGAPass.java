...
public class TestPolicyEGAPass implements PowerMockPolicy {
    ...
    public void applyInterceptionPolicy(MockPolicyInterceptionSettings settings) {
        ...
        settings.stubMethod(PowerMockito.method(TestServiceEG1Impl.class, TestEGCommon.NAME_CHECKA), true);
    }
}