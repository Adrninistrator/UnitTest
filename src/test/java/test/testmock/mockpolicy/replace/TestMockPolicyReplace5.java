...
import test.testmock.mockpolicy.policy.replace.TestPolicyReplace5;
...
public class TestMockPolicyReplace5 extends TestMockBase {
    ...
    public void init() {
        ...
        PowerMockito.replace(PowerMockito.method(TestPublicNonVoidService1Impl.class, TestPublicNonVoidService1Impl
                .NAME_TEST1)).with((proxy, method, args) -> TestConstants.MOCKED);
    }
