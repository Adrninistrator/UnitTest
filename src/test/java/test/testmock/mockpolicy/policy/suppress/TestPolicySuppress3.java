...
public class TestPolicySuppress3 implements PowerMockPolicy {
    ...
    public void applyInterceptionPolicy(MockPolicyInterceptionSettings settings) {
        ...
        settings.addMethodsToSuppress(PowerMockito.method(TestStaticPublicNonVoid1.class,
                TestStaticPublicNonVoid1.NAME_TEST1), PowerMockito.method(TestServiceB1Impl.class, TestServiceB1Impl
                .NAME_TEST1));

        settings.addMethodsToSuppress(new Method[]{PowerMockito.method(TestStaticPublicNonVoid1.class,
                TestStaticPublicNonVoid1.NAME_TEST1), PowerMockito.method(TestServiceB1Impl.class, TestServiceB1Impl
                .NAME_TEST1)});
    }
}
